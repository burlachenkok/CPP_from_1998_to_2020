...
int a[] {1,8,8}
```
Here `{1,8,8}` - is an initialization list. This construction implicitly casts rigth hand side to `std::initializer_list<T>`. Ctor. with initialization, list argument has priority during overloading.
